/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=packages/dumbo/wrangler.durable-object-sqlite.jsonc packages/dumbo/worker-configuration.d.ts` (hash: 4afafa33deca878fc2653b710b37c75c)
// Runtime types generated with workerd@1.20260831.1 2026-08-31 
interface __BaseEnv_Env {
	TEST_OBJECT: DurableObjectNamespace<import("./src/storage/sqlite/durableObject/testing/durableObjectSQLiteTestWorker").DumboDurableObjectSQLiteTestObject>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/storage/sqlite/durableObject/testing/durableObjectSQLiteTestWorker");
		durableNamespaces: "DumboDurableObjectSQLiteTestObject";
	}
