...
describe('PostgreSQL Parametrized Formatter', () => {
  describe('format method', () => {
    ...
    it('handles SQL.in with mode: params using IN syntax', () => {
      const ids = ['id1', 'id2', 'id3'];
    ...
    it('handles SQL.in with mode: native using = ANY syntax (default)', () => {
      const ids = ['id1', 'id2', 'id3'];
    ...
    it('handles SQL.array with mode: params expanding to individual params', () => {
      const ids = ['id1', 'id2', 'id3'];
    ...
    it('handles SQL.array with mode: native as single param (default)', () => {
      const ids = ['id1', 'id2', 'id3'];
    ...
    it('handles SQL.array without mode option (defaults to native)', () => {
      const ids = ['id1', 'id2', 'id3'];
